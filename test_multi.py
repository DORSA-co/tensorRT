...
for i in range(500):
    ...
    thread0 = threading.Thread(target=inf0.do_inference, args=(imgs0 ,batch,HEIGHT,WIDTH) )
    thread1 = threading.Thread(target=inf1.do_inference, args=(imgs1 ,batch,HEIGHT,WIDTH) )
